<#
    ...
    .EXAMPLE
    .\Get-IisLogConfiguration.ps1 -Computers Web01;Web02;Web03
    This will gather the WMI data from Web01, Web02, and Web03 using the credentials you are current logged in with.
    .EXAMPLE
    .\Get-IisLogConfiguration.ps1 -Computers Web01;Web02;Web03 -User 'contoso\administrator'
    ...
    .EXAMPLE
    .\Get-IisLogConfiguration.ps1 -Computers Web01;Web02;Web03 -User 'contoso\administrator' -Password 'LetMeIn123'
    ...
    .Notes
    Name: Get-IisLogConfiguration.ps1
...
$aObjects | Export-Csv -Path '.\Get-IisLogConfigurationcsv' -NoTypeInformation
Write-Host 'Done!'