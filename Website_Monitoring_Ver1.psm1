$help = Get-Content "C:\Users\admins4v89kr\Desktop\Website_Monitoring_Ver1.ps1" | Select-Object -First 8
...
$URLList = Get-Content $URLListFile -ErrorAction SilentlyContinue
  ...
  $result1 = Measure-Command { $request = Invoke-WebRequest -Uri $uri UseDefaultCred?entials }
